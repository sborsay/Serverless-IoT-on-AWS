...
const char* awsEndpoint = "axxxxxxxxxxxxs-ats.iot.us-west-2.amazonaws.com";
...
void loop() {
  ...
  //int ArduinoJson = random(10, 20);
  //char inputx[]="{\"temp\":\"ArduinoJson\",\"stargazers\":{""\"totalCount\":3415},\"issues\":{\"totalCount\":21}}";
 // char inputx[] =  "{\"temp\": + randNumber+ ,\"stargazers\": 21}";
