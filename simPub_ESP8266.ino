 ...
 * Modified by Stephen Borsay   device2cloud.net
 * License: Apache License v2
 *
 * Modified by Stephen Borsay for AWS IoT Serverless on Udemy
 * REPLACE private and client certificate with your own, use your own AWS IoT endpoint
 */
...
const char* awsEndpoint = "<YOUR-AWS-IOT-ENDPOINT>-ats.iot.<YOUR-AWS-REGION>.amazonaws.com";
...
//-----BEGIN CERTIFICATE-----
"XXXXXXXXXkKgAwIBAgIVAI7n0dti6sMuimCVANnjs+8i8TUiMA0GCSqGSIb3DQEB" \
...
"XXXXXXXXXXXCAQEA0UlgP9sUoPzmDjjOndrJiSBJ91SIJqghJq4Nfur3aCgS8YDI" \
...
//-----BEGIN CERTIFICATE-----
"XXXXXXXXXimgAwIBAgITBmyfz5m/jAo54vB4ikPmljZbyjANBgkqhkiG9w0BAQsF" \
